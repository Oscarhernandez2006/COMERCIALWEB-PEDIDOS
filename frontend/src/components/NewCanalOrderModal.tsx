...
interface NewCanalOrderModalProps {
  onClose: () => void;
  /** Se llama tras crear un pedido (para refrescar el consolidado). */
  onCreated?: () => void;
}

/**
 * Modal de creación de pedido de canales. Se pide por unidades (animales) pero
 * se factura por kg: al escribir los kg requeridos se sugieren las unidades
 * según el peso aproximado del ítem. Los datos del cliente (sucursal, ciudad,
 * condición de pago) se toman del cliente seleccionado.
 */
export function NewCanalOrderModal({
  onClose,
  onCreated,
}: NewCanalOrderModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="flex max-h-[92vh] w-full max-w-5xl flex-col overflow-hidden rounded-xl border border-border bg-background shadow-lg">
        {/* Encabezado */}
